 ...
 */
class Version20190109145226 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE book CHANGE type_id type_id INT DEFAULT NULL, CHANGE collection collection VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci, CHANGE rating rating INT DEFAULT NULL');
