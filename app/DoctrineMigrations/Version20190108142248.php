 ...
 */
class Version20190108142248 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE type_id type_id INT DEFAULT NULL, CHANGE rating rating INT DEFAULT NULL');
